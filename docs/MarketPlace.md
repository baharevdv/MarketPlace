...
### [Product (Товары)](./ERD.md/#Product)
### [ProductSubscription (Подписки пользователей на приход товара на склад)](./ERD.md/#ProductSubscription)
### [Storehouse (Склад товара)](./ERD.md/#Storehouse)
### [BasketProduct (Товары в корзине)](./ERD.md/#BasketProduct)
### [Order (Заказы)](./ERD.md/#Order)
### [OrderProduct (Товары в заказе)](./ERD.md/#OrderProduct)
### [PayRequest (Запросы на оплату)](./ERD.md/#)
### [PayTransaction (Транзакции оплат)](./ERD.md/#PayTransaction)
### ERD-схема таблиц БД

![ERD-схема таблиц БД](./images/ERD.svg)

## [Работа с уведомлениями о поступлении товара](./subscribtion.md)

### [Ввод информации о поступлении товара](./subscribtion.md/#Ввод информации о поступлении товара)
